ActionController::Routing::Routes.draw do |map|
  ...
  # games
  #
  map.resources :games, :controller => 'game/games', :member => {:game_details => :get, :area_details => :get} do |games|
		...
		games.resources :attentions, :controller => 'game/attentions'
  ...
  map.resources :friend_requests, :controller => 'friend/requests', :member => {:accept => :put, :decline => :delete}
	...
	map.resources :notifications, :collection => {:first_five => :get}
